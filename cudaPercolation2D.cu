...
/////////////////////////////////////////////////////////////////////////////////////// 
/////////////////////////////////////////////////////////////////////////////////////// 
__global__ void main_kernel_tex( const int nWidth, const int nHeight, unsigned char *isFreeAll,
			     float *concentrationOut, unsigned char *activeBlocks,
			     float *plotData,  const unsigned char showActivity  ){
  int t_j = blockIdx.x*blockDim.x + threadIdx.x;
  int t_i = blockIdx.y*blockDim.y + threadIdx.y;
  int tid = t_j + t_i*blockDim.x*gridDim.x;
...
//   
  unsigned char isFree = isFreeAll[tid];
  ...
  if (t_j == 0)           left_nNeighb = tex2D( tex_nNeighb, nWidth-1, t_i );
